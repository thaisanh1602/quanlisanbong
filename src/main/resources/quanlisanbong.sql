...
CREATE TABLE TaiKhoan (
    ...
    MatKhau VARCHAR(255),
    LoaiTK NVARCHAR(20) -- 'Quan Ly' hoặc 'Nhan Vien'
);
...
CREATE TABLE PhieuDatSan (
    ...
    TrangThaiTT INT DEFAULT 0, -- 0: Chưa thanh toán, 1: Đã thanh toán
...
('admin', '$2a$10$7eGAyPwCINMZ68cOWDLazeVGT9QpTo9YBSgTYff.mMkIhQS1zP.U.', N'Quản lý'),
('nv_nam', '$2a$10$iWzi30Z7btTNJfITGjL7P.B7Ov/jlcmji6ESsrMDV4gC6VeOQyBdS', N'Nhân viên');
...
INSERT INTO PhieuDatSan (TenKhachHang, SDT_Khach, MaSan, NgayThue, GioBatDau, GioKetThuc, Duration, TrangThaiTT) VALUES
(N'Lê Văn Tâm', '0988123123', 'S05_01', '2026-04-05', '17:00:00', '18:30:00', 1.5, 1),
(N'Nguyễn Thị Bình', '0912334455', 'S07_01', '2026-04-06', '19:00:00', '21:00:00', 2.0, 1),
-- Khách này đặt 2 sân cùng lúc
(N'Hoàng Long', '0909999000', 'S05_01', '2026-04-04', '08:00:00', '09:00:00', 1.0, 0);


INSERT INTO HoaDon (NgayLap, SDT_Khach, TongTienSan, GiamGia, Thue, TongThanhToan, SoTienNhan, TienTraLai) VALUES
('2026-04-06 18:30:00', '0988123123', 300000, 0, 5, 315000, 320000, 5000),
('2026-04-05 21:00:00', '0977666555', 500000, 10, 5, 472500, 500000, 27500);
